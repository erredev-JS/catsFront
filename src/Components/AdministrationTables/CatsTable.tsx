            ...
            {catsArray.map((cat) => (
              <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200" key={cat.id}>
                ...
                <td className="py-4 flex justify-around">
                  ...
                  <button type="button" className="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-2 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900" onClick={() => handleDeleteCat(cat.id)}>
                    <span className="material-symbols-outlined">
                      delete
                    </span>
                  </button>
